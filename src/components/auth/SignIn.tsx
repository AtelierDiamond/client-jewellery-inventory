...
import jewellery from '@/components/images/login/login-jewellery.png'
        ...
        <section className='relative'>
            <div className='grid grid-cols-2'>
                ...
                <div className="w-full max-w-md mx-auto px-4 py-8">
                    <div className='bg-[#EBE5DF] rounded-lg shadow-xl w-auto h-auto p-6'>
                        <form className="space-y-4">
                            <h2 className='text-xl font-serif text-center'>LOG IN</h2>
                            <div className="mb-4">
                                <input
                                    type="text"
                                    id="userName"
